...
const Hero = () => {
  return (
    <section className="relative w-full h-[calc(100svh-88px)] min-h-[540px] flex items-center justify-center overflow-hidden">
      <img
        src={heroImage}
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 lg:px-10 w-full py-8 text-white text-center">
        <div className="reveal">
          <h1 className="h-display text-white text-[42px] sm:text-[60px] lg:text-[84px] xl:text-[96px]">
        ...
        <div className="reveal mt-12 lg:mt-24 flex flex-col items-center gap-10">
          ...
          <div className="flex flex-wrap items-center gap-3 justify-center">
            ...
            <Link
              to="/ev-charging"
              className="pill-btn inline-flex items-center gap-3 pl-6 pr-2 py-2 rounded-full bg-white/10 backdrop-blur border border-white/40 text-white text-[15px] font-medium hover:bg-white/20"
            >
        ...
        <div className="hidden md:flex absolute left-6 lg:left-10 bottom-8 items-center gap-2 text-white/80">
          <span className="w-2 h-2 rounded-full bg-white animate-pulse" />
          <span className="h-mono">SINCE 2010 - GURUGRAM, INDIA</span>
        </div>
        <div className="hidden md:block absolute right-6 lg:right-10 bottom-8 text-white/80 h-mono">
