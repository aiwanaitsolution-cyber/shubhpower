    ...
    <div className="max-w-[1500px] mx-auto px-6 lg:px-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 bottom-0 w-1/2 -translate-x-1/2 rounded-[20px] bg-[#0F3328] text-white px-4 py-3 shadow-2xl border border-white/20">
            <div className="h-mono text-[11px] tracking-[0.16em] text-[#7DE0C3]">LIVE SOLUTIONS</div>
            <div className="h-display mt-1 text-[22px] leading-tight">Solar - BESS - EV Charging</div>
          </div>
        </div>
      </div>
